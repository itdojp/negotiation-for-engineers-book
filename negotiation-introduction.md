...
Edmondson（1999）の心理的安全性は、対人的なリスクを取っても安全だという、チーム成員に共有された信念である（[一次論文](https://doi.org/10.2307/2666999)）。本書では、質問、異論、誤り、不確実性を表明しても侮辱や報復で応じない会話条件として用いる。快適さ、無条件の同意、対立の不在、低い品質基準を意味せず、一回の交渉から個人やチームを診断しない。定義、対象、限界は[基礎語彙のSource Notes](docs/foundations/#source-notes-negotiation-foundations)を参照する。
