...
- [リスク分析（サンプル）](../risk/risk-assessment.md) - 失敗時の論点、受容基準、報告フォーマットの整理
- [ROI計算（サンプル）](../analysis/roi-calculation.md) - ROI、回収期間、感度分析の試算例
- [提案資料（サンプル）](../proposals/cloud-migration-phase1.md) - 会議体に出す提案書の構成と記載粒度
- [交渉ログ（サンプル）](../logs/NEG-2024-06-10-001.md) - 交渉後の事実記録と振り返りの記入例
