...
症状からケースを選ぶ場合は [交渉トラブルシューティングフロー]({{ '/appendices/troubleshooting/' | relative_url }}) を、本文の図を確認する場合は [図版索引]({{ '/appendices/figures/' | relative_url }}) を使う。
...
- 「1スプリントで返済できる最小単位に分割し、効果測定（リードタイム/障害件数/MTTR 等）をセットにします」
