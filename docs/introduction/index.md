...
[![エンジニア交渉力を4領域に整理したアーキテクチャ図]({{ '/assets/diagrams/negotiation-architecture.svg' | relative_url }})]({{ '/assets/diagrams/negotiation-architecture.svg' | relative_url }})

*図1：エンジニア交渉力アーキテクチャ（[拡大表示]({{ '/assets/diagrams/negotiation-architecture.svg' | relative_url }})）*

**図の要約**: 中心に「エンジニアの交渉力」を置き、技術的交渉場面、技術力との相乗効果、組織への影響力、本書の6章という4方向へ展開する。図が読めない場合は、交渉場面を特定して対応する章へ進む。

## 図2：エンジニア交渉力成長ロードマップ {#figure-growth-roadmap}

[![実装者からシニアまでの交渉力成長ロードマップ図]({{ '/assets/diagrams/growth-roadmap.svg' | relative_url }})]({{ '/assets/diagrams/growth-roadmap.svg' | relative_url }})

*図2：エンジニア交渉力成長ロードマップ（[拡大表示]({{ '/assets/diagrams/growth-roadmap.svg' | relative_url }})）*

**図の要約**: 実装者、中堅、シニアの順に視野を広げ、各段階で技術的信頼性、ビジネス理解、コミュニケーション、戦略的思考を身につけ、準備、可視化、提案、改善のツールを使う。
